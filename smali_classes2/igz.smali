...
# instance fields
.field private synthetic a:Ligw;


# direct methods
.method constructor <init>(Ligw;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2

    iput-object p1, p0, Ligz;->a:Ligw;
...
.method private final a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .prologue
    .line 0
    invoke-direct {p0, p1, p2}, Ligz;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Ligz;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v2, p2}, Lihq;->a(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private final a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Ligz;->a:Ligw;

    invoke-virtual {v2}, Ligw;->s()Liho;
    ...
    invoke-virtual {v2, v3, p2, v0}, Lihq;->a(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public final getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v1}, Ligw;->a(Ligw;)Ligo;

    move-result-object v1

    invoke-static {}, Ligv;->G()J

    .line 1000
    iget-wide v2, v1, Ligo;->b:J
    ...
    .line 1000
    :cond_1
    iget-object v2, v1, Ligo;->a:Lhlc;

    invoke-interface {v2}, Lhlc;->b()J

    move-result-wide v2

    iget-wide v4, v1, Ligo;->b:J
    ...
    iget-object v0, p0, Ligz;->a:Ligw;

    invoke-static {v0}, Ligw;->a(Ligw;)Ligo;
    ...
    invoke-static {v0}, Ligw;->b(Ligw;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Ligz;->a:Ligw;

    invoke-virtual {v1}, Ligw;->m()Landroid/content/Context;
...
.method public final onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Ligz;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 8000
    sget-object v11, Ligw;->a:Ljava/util/Map;
    ...
    .line 0
    invoke-direct/range {v6 .. v11}, Ligz;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
