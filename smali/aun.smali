...
.method public constructor <init>(Latk;Ljava/lang/String;)V
    ...
    iput v0, p0, Laun;->mPeriod:I

    .line 28
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Laun;->mLastTime:J

    .line 29
    iput v2, p0, Laun;->mTotalFrameCount:I

    .line 30
    iput v2, p0, Laun;->mPeriodFrameCount:I
...
.method public final getSignature()Latp;
    ...
    invoke-virtual {v1, v2, v4, v3}, Latp;->a(Ljava/lang/String;ILasq;)Latp;
    ...
    .line 42
    invoke-virtual {v1, v2, v4, v0}, Latp;->b(Ljava/lang/String;ILasq;)Latp;
...
.method public final onInputPortOpen(Lath;)V
    ...
    invoke-virtual {p0, v0}, Laun;->getConnectedOutputPort(Ljava/lang/String;)Latn;
...
.method protected final onOpen()V
    ...
    .line 60
    iput v0, p0, Laun;->mTotalFrameCount:I

    .line 61
    iput v0, p0, Laun;->mPeriodFrameCount:I
...
.method protected final declared-synchronized onProcess()V
    ...
    invoke-virtual {p0, v0}, Laun;->getConnectedInputPort(Ljava/lang/String;)Lath;
    ...
    .line 70
    iget v1, p0, Laun;->mTotalFrameCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Laun;->mTotalFrameCount:I

    .line 71
    iget v1, p0, Laun;->mPeriodFrameCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Laun;->mPeriodFrameCount:I

    .line 74
    iget-wide v2, p0, Laun;->mLastTime:J
    ...
    iput-wide v2, p0, Laun;->mLastTime:J
    ...
    invoke-virtual {p0, v1}, Laun;->getConnectedOutputPort(Ljava/lang/String;)Latn;
    ...
    iget v2, p0, Laun;->mTotalFrameCount:I

    iget v3, p0, Laun;->mPeriodFrameCount:I

    iget-wide v4, p0, Laun;->mLastTime:J
    ...
    invoke-direct/range {v1 .. v6}, Laum;-><init>(IIJI)V

    .line 87
    const/4 v2, 0x0

    invoke-virtual {v7, v2}, Latn;->a([I)Lasd;
    ...
    .line 88
    invoke-virtual {v2, v1}, Lasr;->a(Ljava/lang/Object;)V

    .line 89
    invoke-virtual {v7, v2}, Latn;->a(Lasd;)V

    .line 90
    iput-wide v8, p0, Laun;->mLastTime:J
