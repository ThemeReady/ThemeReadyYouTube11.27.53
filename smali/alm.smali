...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 48
    iput-object p1, p0, Lalm;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 77
    invoke-direct {p0, v0, p2}, Lalm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Lki;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lalm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 101
    iget-object v0, p0, Lalm;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 102
    iput-object v1, p0, Lalm;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 53
    iget-object v0, p0, Lalm;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lalm;->b:[I
    ...
    .line 56
    invoke-virtual {v4, v3}, Lara;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 58
    iget-object v5, p0, Lalm;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lalm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    :cond_2
    invoke-virtual {v4, v9}, Lara;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 63
    iget-object v1, p0, Lalm;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lalm;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
