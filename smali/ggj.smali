...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    iput-object v0, p0, Lggj;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, Lggj;->b:Landroid/net/Uri;

    .line 98
    const/4 v0, 0x0

    iput-object v0, p0, Lggj;->c:Ljava/util/Map;
...
.method private static a(Landroid/media/MediaFormat;)Lghk;
    .locals 24
    ...
    invoke-static {v0, v1}, Lggj;->a(Landroid/media/MediaFormat;Ljava/lang/String;)I
    ...
    iput-object v0, v1, Lghk;->t:Landroid/media/MediaFormat;
...
.method private final a(JZ)V
    ...
    .line 296
    :cond_0
    iput-wide p1, p0, Lggj;->k:J

    .line 297
    iput-wide p1, p0, Lggj;->l:J

    .line 298
    iget-object v1, p0, Lggj;->e:Landroid/media/MediaExtractor;

    invoke-virtual {v1, p1, p2, v0}, Landroid/media/MediaExtractor;->seekTo(JI)V

    .line 299
    :goto_0
    iget-object v1, p0, Lggj;->i:[I
...
.method public final a(IJLghm;Lgho;)I
    ...
    .line 1280
    iget-object v0, p0, Lggj;->e:Landroid/media/MediaExtractor;
    ...
    invoke-direct {v5, v6, v1}, Lgko;-><init>(Ljava/lang/String;[B)V

    invoke-virtual {v2, v0, v5}, Lgkn;->a(Ljava/util/UUID;Lgko;)V
    ...
    .line 214
    iget-object v0, p5, Lgho;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p5, Lgho;->b:Ljava/nio/ByteBuffer;
    ...
    .line 217
    iget-object v1, p5, Lgho;->b:Ljava/nio/ByteBuffer;
    ...
    .line 224
    iget-object v0, p5, Lgho;->a:Lgfu;

    iget-object v1, p0, Lggj;->e:Landroid/media/MediaExtractor;

    .line 2082
    iget-object v2, v0, Lgfu;->g:Landroid/media/MediaCodec$CryptoInfo;

    invoke-virtual {v1, v2}, Landroid/media/MediaExtractor;->getSampleCryptoInfo(Landroid/media/MediaCodec$CryptoInfo;)Z

    .line 2083
    iget-object v1, v0, Lgfu;->g:Landroid/media/MediaCodec$CryptoInfo;
...
.method public final a(IJ)V
    ...
    :goto_1
    invoke-direct {p0, p2, p3, v1}, Lggj;->a(JZ)V
...
.method public final a(J)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lggj;->a(JZ)V
...
.method public final b()Z
    ...
    .line 132
    iget-object v0, p0, Lggj;->d:Ljava/io/IOException;
    ...
    iput-object v0, p0, Lggj;->e:Landroid/media/MediaExtractor;
    ...
    iget-object v1, p0, Lggj;->a:Landroid/content/Context;

    iget-object v2, p0, Lggj;->b:Landroid/net/Uri;
    ...
    .line 152
    iget-object v1, p0, Lggj;->f:[Lghk;

    iget-object v2, p0, Lggj;->e:Landroid/media/MediaExtractor;

    invoke-virtual {v2, v0}, Landroid/media/MediaExtractor;->getTrackFormat(I)Landroid/media/MediaFormat;

    move-result-object v2

    invoke-static {v2}, Lggj;->a(Landroid/media/MediaFormat;)Lghk;
    ...
    .line 144
    iput-object v0, p0, Lggj;->d:Ljava/io/IOException;

    goto :goto_0

    .line 154
    :cond_2
    iput-boolean v7, p0, Lggj;->g:Z
...
.method public final e()J
    ...
    .line 263
    :cond_0
    iget-object v4, p0, Lggj;->e:Landroid/media/MediaExtractor;
