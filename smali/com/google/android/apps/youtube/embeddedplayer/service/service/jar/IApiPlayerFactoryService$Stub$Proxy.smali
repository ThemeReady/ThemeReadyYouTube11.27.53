...
.method public final a(Lgbo;Lgca;Lgcg;Lgcj;Lgbl;Lgbi;Lgcm;Lgbr;Lgbx;Lgcd;Lgcp;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    ...
    invoke-interface {p1}, Lgbo;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lgca;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lgcg;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lgcj;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lgbl;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lgbi;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lgcm;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lgbr;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lgbx;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lgcd;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lgcp;->asBinder()Landroid/os/IBinder;
