...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1084
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/ui/TintableImageView;->c:Ldxc;
    ...
    iput-object v0, p0, Lcom/google/android/apps/youtube/app/ui/TintableImageView;->c:Ldxc;
    ...
    .line 2245
    iget-object v1, v0, Ldxc;->b:Landroid/content/res/ColorStateList;

    if-nez v1, :cond_3

    .line 2246
    iget-object v1, v0, Ldxc;->a:Landroid/content/Context;

    sget v2, Lwiw;->c:I

    invoke-static {v1, v2, v4}, Llvq;->a(Landroid/content/Context;II)I

    move-result v1

    .line 2247
    iget-object v2, v0, Ldxc;->a:Landroid/content/Context;

    sget v3, Lwiw;->b:I

    invoke-static {v2, v3, v4}, Llvq;->a(Landroid/content/Context;II)I

    move-result v2

    .line 2248
    iget-object v3, v0, Ldxc;->a:Landroid/content/Context;

    sget v4, Lwiw;->d:I

    invoke-static {v3, v4, v2}, Llvq;->a(Landroid/content/Context;II)I

    move-result v3

    .line 2250
    invoke-virtual {v0, v1, v2, v3}, Ldxc;->a(III)Landroid/content/res/ColorStateList;

    move-result-object v1

    iput-object v1, v0, Ldxc;->b:Landroid/content/res/ColorStateList;

    .line 2253
    :cond_3
    iget-object v0, v0, Ldxc;->b:Landroid/content/res/ColorStateList;

    .line 1376
    sget-object v1, Landroid/graphics/PorterDuff$Mode;->SRC_IN:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p1, v0, v1}, Ldxc;->b(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, v1}, Ldxc;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
