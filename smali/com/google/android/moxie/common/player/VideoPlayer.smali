...
.field private x:Lggf;

.field private y:Lghj;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lwhk;)V
    .locals 4
    ...
    invoke-direct {v0, p0}, Lwhh;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V
    ...
    invoke-direct {v0, p0}, Lwhi;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lggf;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lghj;

    .line 162
    iput-object p1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->e:Landroid/content/Context;

    .line 163
    iput-object p2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->b:Lwhk;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lggc;

    .line 165
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lggc;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lggf;
    ...
    invoke-interface {v0, v3}, Lggc;->a(Z)V

    .line 167
    new-instance v0, Lgth;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lggc;

    invoke-direct {v0, v1}, Lgth;-><init>(Lggc;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lgth;
...
.method public static create(Landroid/content/Context;Lwhk;)Lcom/google/android/moxie/common/player/VideoPlayer;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/moxie/common/player/VideoPlayer;-><init>(Landroid/content/Context;Lwhk;)V
...
.method public close()V
    ...
    .line 270
    iput-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lghw;
...
.method public getPlayerControl()Lgth;
    .locals 1

    .prologue
    .line 386
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lgth;
...
.method public open(Ljava/lang/String;I)V
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lwhg;
    ...
    iget-object v3, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lwhg;

    iget-object v6, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lghj;

    invoke-static/range {v0 .. v6}, Lwhl;->a(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;Lggl;Ljava/lang/String;ILghj;)Lwhl;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lghw;

    .line 2222
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lghw;
    ...
    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lghw;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->m:Landroid/view/Surface;

    invoke-interface {v0, v1, v7, v2}, Lggc;->a(Lggd;ILjava/lang/Object;)V

    .line 2226
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lggc;

    new-array v1, v7, [Lghw;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lghw;
...
.method public pause()V
    ...
    .line 306
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lwhg;
...
.method public play(JJZ)V
    ...
    .line 287
    :cond_1
    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lggc;

    invoke-interface {v2}, Lggc;->f()J
...
.method public update(J)Z
    ...
    .line 3048
    iput-wide v2, v0, Lwhg;->a:J

    .line 3049
    invoke-static {v2, v3}, Lwhg;->a(J)J

    move-result-wide v2

    iput-wide v2, v0, Lwhg;->b:J
