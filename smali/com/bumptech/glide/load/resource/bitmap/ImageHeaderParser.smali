...
.method public constructor <init>(Ljava/io/InputStream;Lbbp;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lbbp;

    .line 100
    new-instance v0, Lbho;

    invoke-direct {v0, p1}, Lbho;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbhn;

    .line 101
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Lbbp;)V
    .locals 1
...
.method private static a(Lbhm;)I
    .locals 10
    ...
    invoke-virtual {p0, v0}, Lbhm;->b(I)S
    ...
    .line 5392
    :goto_0
    iget-object v1, p0, Lbhm;->a:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0}, Lbhm;->a(I)I
    ...
    .line 304
    invoke-virtual {p0, v1}, Lbhm;->b(I)S
    ...
    .line 309
    invoke-virtual {p0, v3}, Lbhm;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lbhm;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lbhm;->a(I)I
    ...
    .line 6396
    iget-object v5, p0, Lbhm;->a:Ljava/nio/ByteBuffer;
    ...
    .line 7396
    iget-object v6, p0, Lbhm;->a:Ljava/nio/ByteBuffer;
...
.method private final c()I
    ...
    .line 246
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbhn;

    invoke-interface {v1}, Lbhn;->b()S
    ...
    .line 269
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbhn;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lbhn;->a(J)J
...
.method public final a()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 116
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbhn;

    invoke-interface {v0}, Lbhn;->a()I
    ...
    invoke-interface {v0, v2, v3}, Lbhn;->a(J)J

    .line 129
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbhn;

    invoke-interface {v0}, Lbhn;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lbhn;->a(J)J
...
.method public final b()I
    ...
    .line 193
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lbbp;

    const-class v3, [B

    invoke-interface {v0, v2, v3}, Lbbp;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v0, v2}, Lbhn;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lbbp;

    const-class v3, [B

    invoke-interface {v2, v0, v3}, Lbbp;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    invoke-direct {v1, v0, v2}, Lbhm;-><init>([BI)V

    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lbhm;)I
    :try_end_1
