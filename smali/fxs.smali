...
# direct methods
.method public constructor <init>(Landroid/view/View;Lfxe;Lfxz;)V
    .locals 6
    ...
    .line 136
    invoke-direct/range {v0 .. v5}, Lfxs;-><init>(Landroid/view/View;Lfxe;Lfxz;Landroid/os/Looper;Ljava/util/Random;)V

    .line 149
    return-void
.end method

.method private constructor <init>(Landroid/view/View;Lfxe;Lfxz;Landroid/os/Looper;Ljava/util/Random;)V
    .locals 2
    ...
    iput-object v0, p0, Lfxs;->a:Landroid/view/View;
    ...
    iput-object v0, p0, Lfxs;->c:Ljava/util/Random;

    .line 116
    iput-boolean v1, p0, Lfxs;->p:Z

    .line 117
    iput-boolean v1, p0, Lfxs;->q:Z

    .line 118
    iput-boolean v1, p0, Lfxs;->r:Z

    .line 119
    const-string v0, "normalMinimumPeriod must be >= 0"

    invoke-static {v1, v0}, Llhi;->a(ZLjava/lang/Object;)V
    ...
    iput-object v0, p0, Lfxs;->h:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lfxs;->s:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lfxs;->t:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lfxs;->u:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lfxs;->v:Landroid/graphics/Rect;
...
.method private final a(Landroid/view/View;)Z
    ...
    .line 283
    iget-object v0, p0, Lfxs;->a:Landroid/view/View;

    iget-object v1, p0, Lfxs;->s:Landroid/graphics/Rect;

    invoke-static {v0, v1}, Lfxs;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 285
    iget-object v2, p0, Lfxs;->a:Landroid/view/View;
    ...
    invoke-static {v0, v2, v1}, Lfxs;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 292
    iget-boolean v1, p0, Lfxs;->p:Z

    if-eqz v1, :cond_1

    .line 294
    iget-object v1, p0, Lfxs;->t:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Lfxs;->s:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lfxs;->t:Landroid/graphics/Rect;

    iget-object v3, p0, Lfxs;->s:Landroid/graphics/Rect;

    .line 301
    invoke-static {v2, v3}, Lfxs;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v0, p0, Lfxs;->l:Ljava/lang/String;
    ...
    .line 313
    iget-object v0, p0, Lfxs;->s:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v0 .. v6}, Lfxs;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method private final a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
    ...
    .prologue
    .line 332
    iget-object v4, p0, Lfxs;->u:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v4}, Lfxs;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 335
    iget-object v4, p0, Lfxs;->v:Landroid/graphics/Rect;

    move-object/from16 v0, p1

    invoke-static {v0, v4}, Lfxs;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 336
    iget-object v4, p0, Lfxs;->v:Landroid/graphics/Rect;

    iget-object v5, p0, Lfxs;->u:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->left:I

    iget-object v6, p0, Lfxs;->u:Landroid/graphics/Rect;
    ...
    iget-object v8, p0, Lfxs;->u:Landroid/graphics/Rect;

    iget-object v9, p0, Lfxs;->v:Landroid/graphics/Rect;
    ...
    .line 3367
    invoke-static {v9, v8}, Lfxs;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v4, p0, Lfxs;->l:Ljava/lang/String;
    ...
    .line 3371
    invoke-static {v8, v9}, Lfxs;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    .line 355
    invoke-direct/range {v4 .. v10}, Lfxs;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method public final a()V
    ...
    .line 153
    iget-object v0, p0, Lfxs;->h:Landroid/os/Handler;
...
.method public final c()Z
    ...
    .line 261
    invoke-direct {p0, v0}, Lfxs;->a(Landroid/view/View;)Z
