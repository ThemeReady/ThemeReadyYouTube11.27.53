...
.method public constructor <init>(Lgzu;)V
    ...
    iput-object v0, p0, Lgzv;->b:Ljava/io/ByteArrayOutputStream;
...
.method public final a(Lgzr;)Z
    ...
    invoke-virtual {v0, p1, v1}, Lgzu;->a(Lgzr;Z)Ljava/lang/String;
    ...
    :cond_2
    iget-object v4, p0, Lgzv;->b:Ljava/io/ByteArrayOutputStream;
    ...
    :cond_4
    :try_start_0
    iget-object v0, p0, Lgzv;->b:Ljava/io/ByteArrayOutputStream;
    ...
    iget-object v1, p0, Lgzv;->c:Lgzu;

    const-string v3, "Failed to write payload when batching hits"

    invoke-virtual {v1, v3, v0}, Lgzu;->d(Ljava/lang/String;Ljava/lang/Object;)V
