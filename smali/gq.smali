...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;Landroid/view/View;)V
    ...
    .prologue
    .line 353
    iput-object p1, p0, Lgq;->a:Landroid/view/View;

    iput-object p2, p0, Lgq;->b:Landroid/transition/Transition;

    iput-object p3, p0, Lgq;->c:Ljava/util/ArrayList;

    iput-object p4, p0, Lgq;->d:Landroid/transition/Transition;

    iput-object p5, p0, Lgq;->e:Ljava/util/ArrayList;

    iput-object p6, p0, Lgq;->f:Landroid/transition/Transition;

    iput-object p7, p0, Lgq;->g:Ljava/util/ArrayList;

    iput-object p8, p0, Lgq;->h:Ljava/util/Map;

    iput-object p9, p0, Lgq;->i:Ljava/util/ArrayList;

    iput-object p10, p0, Lgq;->j:Landroid/transition/Transition;

    iput-object p11, p0, Lgq;->k:Landroid/view/View;
...
.method public final onPreDraw()Z
    ...
    .line 355
    iget-object v0, p0, Lgq;->a:Landroid/view/View;
    ...
    .line 356
    iget-object v0, p0, Lgq;->b:Landroid/transition/Transition;
    ...
    iget-object v1, p0, Lgq;->c:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Lgm;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    .line 359
    :cond_0
    iget-object v0, p0, Lgq;->d:Landroid/transition/Transition;
    ...
    iget-object v1, p0, Lgq;->e:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Lgm;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    .line 362
    :cond_1
    iget-object v0, p0, Lgq;->f:Landroid/transition/Transition;
    ...
    iget-object v1, p0, Lgq;->g:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Lgm;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    .line 365
    :cond_2
    iget-object v0, p0, Lgq;->h:Ljava/util/Map;
    ...
    .line 370
    :cond_3
    iget-object v0, p0, Lgq;->i:Ljava/util/ArrayList;
    ...
    .line 372
    iget-object v4, p0, Lgq;->j:Landroid/transition/Transition;
    ...
    .line 374
    :cond_4
    iget-object v0, p0, Lgq;->j:Landroid/transition/Transition;

    iget-object v1, p0, Lgq;->k:Landroid/view/View;
