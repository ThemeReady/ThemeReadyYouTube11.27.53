...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbhi;->d:Ljava/util/Set;
    ...
    sput-object v0, Lbhi;->e:Ljava/util/Set;

    .line 82
    invoke-static {v4}, Lbmc;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Lbhi;->f:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Landroid/util/DisplayMetrics;Lbbu;Lbbp;)V
    .locals 1
    ...
    iput-object v0, p0, Lbhi;->h:Landroid/util/DisplayMetrics;
...
.method private final a(Ljava/io/InputStream;)I
    ...
    iget-object v2, p0, Lbhi;->i:Lbbp;

    invoke-direct {v1, p1, v2}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Lbbp;)V
...
.method private final a(Ljava/io/InputStream;Layd;)Landroid/graphics/Bitmap$Config;
    .locals 4
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbhk;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 7060
    sget-object v3, Lbhu;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 8060
    sget-object v1, Lbhu;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 8488
    invoke-static {p1}, Lbhi;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lbhi;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private final b(Ljava/io/InputStream;)Z
    ...
    .line 356
    sget-object v1, Lbhi;->e:Ljava/util/Set;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lbhi;->f:Ljava/util/Queue;
    ...
    .line 504
    :try_start_1
    sget-object v0, Lbhi;->f:Ljava/util/Queue;
    ...
    .line 508
    invoke-static {v0}, Lbhi;->d(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method private static c(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 515
    invoke-static {p0}, Lbhi;->d(Landroid/graphics/BitmapFactory$Options;)V

    .line 516
    sget-object v1, Lbhi;->f:Ljava/util/Queue;
...
# virtual methods
.method public final a(Ljava/io/InputStream;IILayl;Lbhk;)Lbbi;
    .locals 18
    ...
    invoke-static {v2, v3}, Lbmb;->a(ZLjava/lang/String;)V

    .line 150
    move-object/from16 v0, p0

    iget-object v2, v0, Lbhi;->i:Lbbp;

    const/high16 v3, 0x10000

    const-class v4, [B

    invoke-interface {v2, v3, v4}, Lbbp;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 151
    invoke-static {}, Lbhi;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 154
    sget-object v3, Lbhi;->a:Layi;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Layl;->a(Layi;)Ljava/lang/Object;
    ...
    .line 155
    sget-object v4, Lbhi;->b:Layi;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Layl;->a(Layi;)Ljava/lang/Object;
    ...
    invoke-static {v0, v10, v1}, Lbhi;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbhk;)Landroid/graphics/Bitmap;
    ...
    .line 3177
    invoke-direct/range {p0 .. p1}, Lbhi;->a(Ljava/io/InputStream;)I

    move-result v12

    .line 3178
    invoke-static {v12}, Lbhu;->a(I)I
    ...
    invoke-direct {v0, v1, v3}, Lbhi;->a(Ljava/io/InputStream;Layd;)Landroid/graphics/Bitmap$Config;
    ...
    .line 4316
    :cond_2
    invoke-direct/range {p0 .. p1}, Lbhi;->b(Ljava/io/InputStream;)Z
    ...
    .line 4318
    invoke-static {v10}, Lbhi;->a(Landroid/graphics/BitmapFactory$Options;)Z
    ...
    .line 4496
    invoke-interface {v4, v6, v8, v3}, Lbbu;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lbhi;->g:Lbbu;

    move-object/from16 v0, p5

    invoke-interface {v0, v3, v4}, Lbhk;->a(Lbbu;Landroid/graphics/Bitmap;)V
    ...
    .line 5447
    invoke-static {v4}, Lbhi;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    .line 5449
    invoke-static {v10}, Lbhi;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lbhi;->h:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v3, v4, v12}, Lbhu;->a(Lbbu;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lbhi;->g:Lbbu;

    invoke-interface {v5, v4}, Lbbu;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4}, Lbgw;->a(Landroid/graphics/Bitmap;Lbbu;)Lbgw;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 162
    invoke-static {v10}, Lbhi;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 163
    move-object/from16 v0, p0

    iget-object v4, v0, Lbhi;->i:Lbbp;

    const-class v5, [B

    invoke-interface {v4, v2, v5}, Lbbp;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    :cond_8
    :try_start_1
    invoke-virtual {v4, v9, v7, v6, v8}, Lbha;->a(IIII)F
    ...
    :cond_b
    :try_start_2
    invoke-virtual {v4, v7, v9, v6, v8}, Lbha;->a(IIII)F
    ...
    sget-object v13, Lbhi;->d:Ljava/util/Set;
