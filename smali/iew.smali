...
# static fields
.field private static volatile e:Liew;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Liew;->a:Landroid/content/Context;

    new-instance v0, Liey;

    invoke-direct {v0, p0}, Liey;-><init>(Liew;)V

    iput-object v0, p0, Liew;->c:Liey;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Liew;->b:Ljava/util/List;
...
.method public static a(Landroid/content/Context;)Liew;
    .locals 2

    invoke-static {p0}, Lhkq;->a(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Liew;->e:Liew;
    ...
    invoke-direct {v0, p0}, Liew;-><init>(Landroid/content/Context;)V
...
.method public final a()Liff;
    ...
    .line 1000
    iput-object v1, v2, Liff;->c:Ljava/lang/String;
    ...
    .line 2000
    iput-object v0, v2, Liff;->d:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iget-object v4, p0, Liew;->a:Landroid/content/Context;
    ...
    .line 4000
    iput-object v0, v2, Liff;->b:Ljava/lang/String;

    .line 0
    iput-object v2, p0, Liew;->f:Liff;
...
.method public final a(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    ...
    :cond_0
    iget-object v0, p0, Liew;->c:Liey;

    invoke-virtual {v0, p1}, Liey;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
...
.method public final a(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p1}, Liey;->submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
