...
.field public static final HIDDEN_METHOD_INVOKER:Laqk;
...
.field private mOnCloseListener:Laql;
...
.field private mOnQueryChangeListener:Laqm;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Laqn;
...
.field private mSuggestionsAdapter:Lxf;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Laqk;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 278
    invoke-direct {p0, p1, p2, p3}, Lani;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 172
    new-instance v0, Lapy;

    invoke-direct {v0, p0}, Lapy;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqc;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqd;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqh;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqi;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqj;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapz;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqa;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqb;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mDrawableManager:Lalb;

    .line 282
    sget-object v0, Lads;->bg:[I
    ...
    invoke-virtual {v1, v2, v3}, Lara;->e(II)I
    ...
    invoke-virtual {v1, v2}, Lara;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v2, p0}, Laqe;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v0, v5}, Lara;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Lara;->c(II)I
    ...
    invoke-virtual {v1, v0}, Lara;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0, v4}, Lara;->a(II)I
...
.method public static synthetic access$100(Landroid/support/v7/widget/SearchView;)Lxf;
    .locals 1

    .prologue
    .line 103
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lxf;
...
.method private addOnLayoutChangeListenerToDropDownAnchorBase()V
    ...
    invoke-direct {v1, p0}, Laqg;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private addOnLayoutChangeListenerToDropDownAnchorSDK11()V
    ...
    invoke-direct {v1, p0}, Laqf;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Laqs;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Laqs;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    .prologue
    .line 1662
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Laqk;
...
.method private launchSuggestion(IILjava/lang/String;)Z
    ...
    .line 6194
    iget-object v0, v0, Lxf;->c:Landroid/database/Cursor;
...
.method private onCloseClicked()V
    ...
    .line 1178
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Laql;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Laql;

    invoke-interface {v0}, Laql;->a()Z
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1351
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqn;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqn;

    invoke-interface {v1}, Laqn;->b()Z
...
.method private onItemSelected(I)Z
    ...
    .prologue
    .line 1362
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqn;
...
.method private onSubmitQuery()V
    ...
    .line 1158
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Laqm;
...
.method private onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {p3}, Lqw;->a(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1}, Laqk;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1149
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Laqm;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    .line 1405
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lxf;

    .line 5194
    iget-object v1, v1, Lxf;->c:Landroid/database/Cursor;
    ...
    .line 1411
    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lxf;

    invoke-virtual {v2, v1}, Lxf;->b(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-virtual {v0, v2}, Lxf;->a(Landroid/database/Cursor;)V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Laqs;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lxf;
...
.method public clearFocus()V
    ...
    .line 513
    invoke-super {p0}, Lani;->clearFocus()V
...
.method public getSuggestionsAdapter()Lxf;
    .locals 1
...
.method protected onDetachedFromWindow()V
    ...
    .line 920
    invoke-super {p0}, Lani;->onDetachedFromWindow()V
...
.method protected onMeasure(II)V
    ...
    .line 785
    invoke-super {p0, p1, p2}, Lani;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Lani;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1317
    invoke-super {p0, p1}, Lani;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1321
    invoke-virtual {p1}, Laqo;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Lani;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    .line 1322
    iget-boolean v0, p1, Laqo;->a:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .prologue
    .line 1308
    invoke-super {p0}, Lani;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Laqo;-><init>(Landroid/os/Parcelable;)V
...
.method public onWindowFocusChanged(Z)V
    ...
    .prologue
    .line 1238
    invoke-super {p0, p1}, Lani;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 504
    :cond_3
    invoke-super {p0, p1, p2}, Lani;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Laql;)V
    .locals 0

    .prologue
    .line 534
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Laql;
...
.method public setOnQueryTextListener(Laqm;)V
    .locals 0

    .prologue
    .line 525
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Laqm;
...
.method public setOnSuggestionListener(Laqn;)V
    .locals 0

    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqn;
...
.method public setSuggestionsAdapter(Lxf;)V
    .locals 2

    .prologue
    .line 750
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lxf;
